...
document.addEventListener("load", populateField)
...
myCardSet.forEach(function(card){
    let newTile = document.createElement("div");
    let newCard = document.createElement("img");
    let imageURL = newCard.setAttribute("src", "url(img/" + card + ".jpg");
    newCard.setAttribute("src", card);
...
function onClickCard(e){
    e.target(myField).console.log(myField);
}
